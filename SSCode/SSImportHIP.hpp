...
int SSImportHIP ( const string &filename, SSIdentifierMap &hrMap, SSIdentifierMap &bayMap, SSIdentifierMap &varMap, SSIdentifierNameMap &nameMap, SSObjectVec &hicStars, SSObjectVec &hip2Stars, SSObjectVec &varStars, SSObjectVec &stars );
