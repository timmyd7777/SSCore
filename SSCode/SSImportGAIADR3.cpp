...
// GAIA stars fainter than the Johnson V magnitude limit (vmax) are discarded, unless thay
// have HIP or TYC identifiers.
...
int SSImportGAIA17 ( const string &filename, SSObjectArray &stars, float vmax )
{
    ...
    while ( true )
    {
        ...
        // Discard stars fainter than V magnitude limit unless they have HIP/TYC identifiers
        
        if ( vmag > vmax && gaia.hip_source_id == 0 && gaia.tyc_source_id == 0 )
            continue;
